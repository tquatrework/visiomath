...
interface FullUserProfileResponse {
  user: Omit<User, 'password' | 'toJSON' | 'addTeacherProfilPaymentInfo' | 'increaseTeacherAmountToInvoice'>;
  profile: UserProfile;
...
export class UserProfileService {
   ...
   */
  async getUserProfile(userId: number): Promise<{ user: Omit<User, 'password' | 'toJSON' | 'addTeacherProfilPaymentInfo' | 'increaseTeacherAmountToInvoice'>; profile: UserProfile }> {
