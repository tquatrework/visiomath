...
const  generateUserToken = async (app: INestApplication, role: string): Promise<string> => {
    ...
    await dataSource.query(`
        ...
        INSERT INTO public.teacher_profiles (id, diplomes, experience, specialites, particularites, "cvUrl", "userProfileId", "companyName", "siret", "companyType", "vatExempt", "iban", "bic") VALUES (1, 'test', '5', 'dev', 'dev', 'dev.pdf', 1, null, null, null, null, null, null);
