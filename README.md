...
- `docker compose --env-file .env.prod -f docker-compose-vma.prod.yml build && docker compose --env-file .env.prod -f docker-compose-vma.prod.yml up`
...
- supprimer le point d'api qui permet de créer un admin financier